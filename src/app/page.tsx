  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-700">
      <header className="space-y-1">
        <h2 className="text-3xl font-bold tracking-tight text-foreground/80">Hello, Parent! 👋</h2>
        <p className="text-muted-foreground">Here&apos;s how your little one is doing today.</p>
      </header>
